...
from flaskr.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
#         flash(f"A reset email has been sent to {user.email}", 'info')
#         return redirect(url_for('login'))
